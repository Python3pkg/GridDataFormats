...
copyright = '2007-2016, Oliver Beckstein, Jan Domanski, Max Linke, Jesse Johnson'
...
latex_documents = [
  ('index', 'gridDataFormats.tex', 'gridDataFormats Documentation',
...
man_pages = [
    ('index', 'griddataformats', 'gridDataFormats Documentation',
     ['Oliver Beckstein', 'Max Linke', 'Jesse Johnson'], 1)
]
...
texinfo_documents = [
  ('index', 'gridDataFormats', 'gridDataFormats Documentation',
   'Oliver Beckstein', 'gridDataFormats', 'One line description of project.',
   'Miscellaneous'),
]
